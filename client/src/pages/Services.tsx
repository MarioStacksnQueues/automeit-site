...
import { Bot, Mail, FileText, Code2, ArrowRight, MessageCircle } from "lucide-react";
...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      visualization: <ReceptionistVisualization />
    },
    {
      id: "ai-customer-support",
      icon: <MessageCircle className="w-12 h-12 text-cyan-400" />,
      title: "AI Customer Support Automation",
      description: "Resolve customer questions instantly, reduce ticket volume, and route complex issues to a human—so support stays fast even after hours.",
      features: [
    ...
    },
    {
      ...
      visualization: <CustomWorkflowVisualization />
    }
  ];
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex-1 w-full">
                <div className="glass-card p-1 rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent min-h-[400px] flex items-center justify-center relative overflow-hidden">
